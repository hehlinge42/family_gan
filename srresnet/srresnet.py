...
parser.add_argument(
    ...
    action="store_true",
    help=(
        "By default, the optimized model is used, but with this option, "
...
parser.add_argument(
    ...
    action="store_true",
    help=(
        "Instead of resizing input image when loading it, "
...
# Main functions
# ======================
def recognize_from_image(input_paths, output_paths):
    # net initialize
...
def recognize_from_image_tiling(input_paths, output_paths):
    # net initialize
    net = ailia.Net(MODEL_PATH, WEIGHT_PATH, env_id=args.env_id)
